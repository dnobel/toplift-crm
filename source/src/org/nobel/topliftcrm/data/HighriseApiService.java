...
public class HighriseApiService {
    ...
    public static String getHighriseEndpointUrl(SharedPreferences sharedPreferences) {
        String companyId = sharedPreferences.getString(COMPANY_ID, null);
        return getHighriseEndpointUrl(companyId);
    }

    public static String getHighriseEndpointUrl(String companyId) {
